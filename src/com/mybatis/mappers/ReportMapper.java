...
public interface ReportMapper {	
	...
	Object logout(Map guiMapMessage);

	List<HashMap> show_Reportsdetails(Map guiMapMessage);

	List<HashMap> show_ColoumnNamesbasedonid(Map guiMapMessage);

	void insertIntoEmployee(Map guiMapMessage);

	void changeEmployeePassword(Map guiMapMessage);

	void forgetpassword(Map guiMapMessage);

	void editdashboardOfEmployee(Map guiMapMessage);
